...
<button
onClick={onClick}
className={`w-full text-left flex gap-3 px-4 py-2.5 transition border-b border-gray-900 last:border-0 hover:bg-gray-800/60 ${active ? 'bg-indigo-950/50 border-l-2 border-l-indigo-500' : ''}`}
>
{/* Timestamp */}
